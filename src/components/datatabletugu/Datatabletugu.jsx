...
const Datatabletugu = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("tugu").innerHTML;
  ...
  return (
    <div id="tugu" className="datatabletugu">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatabletuguTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
