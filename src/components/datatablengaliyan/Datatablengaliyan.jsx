...
const Datatablengaliyan = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("ngaliyan").innerHTML;
  ...
  return (
    <div id="ngaliyan" className="datatablengaliyan">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatablengaliyanTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
...
export default Datatablengaliyan;
