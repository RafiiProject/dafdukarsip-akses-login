import "./datatablegunungpati.scss";
...
const Datatablegunungpati = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("gunungpati").innerHTML;
  ...
  return (
    <div id="gunungpati" className="datatablegunungpati">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatablegunungpatiTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
...
export default Datatablegunungpati;
