...
const Datatablebarat = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("barat").innerHTML;
  ...
  return (
    <div id="barat" className="datatablebarat">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatablebaratTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
