import "./datatablecandisari.scss";
...
const Datatablecandisari = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("candisari").innerHTML;
...
export default Datatablecandisari;
