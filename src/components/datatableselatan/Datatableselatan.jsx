...
const Datatableselatan = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("selatan").innerHTML;
  ...
  return (
    <div id="selatan" className="datatableselatan">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatableselatanTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
...
export default Datatableselatan;
