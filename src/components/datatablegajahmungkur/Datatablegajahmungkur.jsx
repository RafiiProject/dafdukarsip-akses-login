import "./datatablegajahmungkur.scss";
...
const Datatablegajahmungkur = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("gajahmungkur").innerHTML;
...
export default Datatablegajahmungkur;
