...
const Datatablegenuk = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("genuk").innerHTML;
  ...
  return (
    <div id="genuk" className="datatablegenuk">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatablegenukTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
