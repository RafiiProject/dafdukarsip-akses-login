...
const Datatabletimur = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("timur").innerHTML;
  ...
  return (
    <div id="timur" className="datatabletimur">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatabletimurTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
