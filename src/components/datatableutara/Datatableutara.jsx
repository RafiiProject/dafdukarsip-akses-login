...
const Datatableutara = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("utara").innerHTML;
  ...
  return (
    <div id="utara" className="datatableutara">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatableutaraTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
