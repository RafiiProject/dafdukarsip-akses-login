import "./datatabletembalang.scss";
...
const Datatabletembalang = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("tembalang").innerHTML;
  ...
  return (
    <div id="tembalang" className="datatabletembalang">
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatabletembalangTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
...
export default Datatabletembalang;
