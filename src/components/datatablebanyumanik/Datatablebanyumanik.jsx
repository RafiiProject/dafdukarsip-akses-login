import "./datatablebanyumanik.scss";
...
const Datatablebanyumanik = () => {
  ...
  const handlePrint = () => {
    const printContents = document.getElementById("banyumanik").innerHTML;
      ...
      {!loading && (
        <>
          <div className="datatablehead">
            <div className="datatablebanyumanikTitle">
              <Link
                to={"/" + type + "/new"}
                style={{ textDecoration: "none" }}
              >
...
export default Datatablebanyumanik;
